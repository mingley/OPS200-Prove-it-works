  ...
  render() {
    return (
      <div className='App'>
        ...
        <input onChange={this.handleChange} name='interestRate' id='interestRate'/>
        <input onChange={this.handleChange} name='loanTerm' id='loanTerm'/>
        <select onChange={this.handleChange} name='period' id='period'>
